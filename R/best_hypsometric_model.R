...
#'
#' @return a list containing three elements. The element `name` contains the name of the selected model. The second element, named `model` is the `lm` object. The third, named `transform`, is a string to be used in the `predict_h` function.
#'
#' @export
