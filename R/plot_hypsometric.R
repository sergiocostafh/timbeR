...
#'
#' Plot the curves generated by the fit of the twelve hypsometric models of the `fit_hypsometric` function, with the observed data and goodness-of-fit statistics.
#'
...
plot_hypsometric <- function(fit_hypsometric_list) {
  ...
  labels <- fit_hypsometric_list$model_evaluation %>%
